...
class HomeController extends GetxController{
  ...
  void onReady() {
    ...
    //tabs -> index->controller- save -> sei index pass kora hocche -> tabs[index]-> House-> dummyData['House'].length-> dummyData['House'][2]['image']
